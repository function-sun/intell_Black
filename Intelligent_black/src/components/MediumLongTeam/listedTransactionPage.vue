<template>
    <div class="listedTransAction">
        <div class="radioBtn" v-if="preLeftMeun === 3">
        ...
        <div class="timeSeach" v-if="showTimev &&preLeftMeun === 3">
            <el-row>
                <el-col :span="12">
                    ...
                    <el-row style="margin-top:10px;">
                        <el-col :span="12">
                            <span>开始时间：</span>
                            <el-time-select v-model="startTime0" :picker-options="startpickerOption" placeholder="选择时间"></el-time-select>
                        </el-col>
                        <el-col :span="12">
                            <span>结束时间：</span>
                            <el-time-select v-model="endTime0" :picker-options="endpickerOption" placeholder="选择时间"></el-time-select>
                        </el-col>
                    </el-row>
                </el-col>
                <el-col :span="12">
                    ...
                    <el-row style="margin-top:10px;">
                        <el-col :span="12">
                            <span>开始时间：</span>
                            <el-time-select v-model="startTime1" :picker-options="startpickerOption" placeholder="选择时间"></el-time-select>
                        </el-col>
                        <el-col :span="12">
                            <span>结束时间：</span>
                            <el-time-select v-model="endTime1" :picker-options="endpickerOption" placeholder="选择时间"></el-time-select>
                        </el-col>
                    </el-row>
                </el-col>
                <el-col :span="12">
                    ...
                    <el-row style="margin-top:10px;">
                        <el-col :span="12">
                            <span>开始时间：</span>
                            <el-time-select v-model="startTime2" :picker-options="startpickerOption" placeholder="选择时间"></el-time-select>
                        </el-col>
                        <el-col :span="12">
                            <span>结束时间：</span>
                            <el-time-select v-model="endTime2" :picker-options="endpickerOption" placeholder="选择时间"></el-time-select>
                        </el-col>
                    </el-row>
                </el-col>
                <el-col :span="12">
                    ...
                    <el-row style="margin-top:10px;">
                        <el-col :span="12">
                            <span>开始时间：</span>
                            <el-time-select v-model="startTime3" :picker-options="startpickerOption" placeholder="选择时间"></el-time-select>
                        </el-col>
                        <el-col :span="12">
                            <span>结束时间：</span>
                            <el-time-select v-model="endTime3" :picker-options="endpickerOption" placeholder="选择时间"></el-time-select>
                        </el-col>
                    </el-row>
                </el-col>
                <el-col :span="12">
                    ...
                    <el-row style="margin-top:10px;">
                        <el-col :span="12">
                            <span>开始时间：</span>
                            <el-time-select v-model="startTime4" :picker-options="startpickerOption" placeholder="选择时间"></el-time-select>
                        </el-col>
                        <el-col :span="12">
                            <span>结束时间：</span>
                            <el-time-select v-model="endTime4" :picker-options="endpickerOption" placeholder="选择时间"></el-time-select>
                        </el-col>
                    </el-row>
                </el-col>
            </el-row>
        ...
        <div class="listedCen">
            ...
            <div class="tableDetail" style="margin-top:50px;padding:0 20px;">
                <el-table :data="mediuTableData" style="width: 100%"
                :header-cell-style="{backgroundColor:'transparent',fontSize:'15px'}"
                :cell-style="{color: '#fff',backgroundColor:'transparent',fontSize:'13px'}"
                :row-style="{color: '#fff',backgroundColor:'transparent',fontSize:'13px'}">
            ...
            <div class="tableDetail" style="margin-top:20px;padding:0 20px;">
                <el-table :data="addmediuTableData" style="width: 100%"
                :header-cell-style="{backgroundColor:'transparent',fontSize:'15px'}"
                :cell-style="{color: '#fff',backgroundColor:'transparent',fontSize:'13px'}"
                :row-style="{color: '#fff',backgroundColor:'transparent',fontSize:'13px'}">
...
export default {
    ...
    methods:{
        ...
        getLinex(xA, serise, lenged){
            ...
            this.isShow = true
            // 基于准备好的dom，初始化echarts实例
            let myChartx = this.$echarts.init(document.getElementById('myChartx'), 'dark')
