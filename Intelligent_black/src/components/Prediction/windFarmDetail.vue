<template>
  <div class="windframdetail">
        <span @click="backPage" style="color:#fff;cursor:pointer">返回</span>
        <div class="detailPic">
...
.windframdetail{
    ...
    .detailPic{
        ...
        .niushoushanF{
            width:1260px;
            height:560px;
            background-image: url('../../assets/windFramPicture/niushoushan_vb.png');
            position: relative;
            left:10%;
            .zhubian1{
                top: 197px;
        ...
        .qinshanshanF{
            width:1260px;
            height:560px;
            background-image: url('../../assets/windFramPicture/qingshan_vb.png');
            position: relative;
            left:10%;
            .zhubian2{
                top: 10px;
        ...
        .shibanquanF{
            width:1260px;
            height:560px;
            background-image: url('../../assets/windFramPicture/shibanquan_vb.png');
            position: relative;
            left:10%;
            .zhubian3{
                top: 127px;
        ...
        .xiangshanF{
            width:1260px;
            height:560px;
            background-image: url('../../assets/windFramPicture/xiangshan_vb.png');
            position: relative;
            left:10%;
            .zhubian1{
                top: 0;
        ...
        .mahuangshanF{
            width:1260px;
            height:560px;
            background-image: url('../../assets/windFramPicture/mahuangshan_vb.png');
            position: relative;
            left:10%;
            .zhubian1{
                top: 15px;
