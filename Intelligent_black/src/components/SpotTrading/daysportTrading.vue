        ...
        <div class="showchartTable" v-loading="loading">
            <el-row style="margin-top:10px">
                <el-col :span="12" style="padding: 0 20px;border-right: 1px dashed #EBEEF5;">
                    ...
                    <el-button style="margin:20px 0 10px 0" @click="exportExcel('CQ')">导出日出清电价Excel文档</el-button>
                ...
                <el-col :span="12" style="padding: 0 20px;">
                    ...
                    <el-button style="margin:20px 0 10px 0" @click="exportExcel('CL')">导出日出清电力Excel文档</el-button>
                    <div class="tableDetail">
...
export default {
    ...
    methods:{
        ...
        getdeclare() {
            ...
            that.$http.post(url, params).then(datas =>{
                if (datas && datas.data) {
                    ...
                    this.getLine('daysChart', Xaxis, legend, series)
                    this.getLine('daysChartX', Xaxis, legendX, seriesX)
                }
            })
        },
        // 查询表格数据
        ...
        getLine(name, xaxis, legendFn, seriesFn){
            // 绘制图表
            let option = ({
                backgroundColor: '',
                title: {
                    text: name === 'daysChart' ? '出清电价' : '出清电力',
                    textStyle: {
                        fontSize: 16
                    },
                    left: 30,
