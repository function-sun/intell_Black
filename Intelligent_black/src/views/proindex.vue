                    ...
                    <el-row class="proTable">
                        <el-col :span="24">
                            ...
                            <div class="tableDetail">
                                ...
                                :header-cell-style="{backgroundColor:'transparent',color:'#ffffff',fontSize:'15px'}"
...
export default {
    ...
    methods:{
        ...
        getLine(xaxis, legendFn, seriesFn){
            ...
            let myChart = this.$echarts.init(document.getElementById('indexChart'), 'dark')
        ...
        getAsLine(xaxis, legendFn, seriesFn){
            ...
            // 基于准备好的dom，初始化echarts实例
            let myChart = this.$echarts.init(document.getElementById('indexAsChart'), 'dark')
            myChart.setOption(option);
            window.addEventListener("resize", function () {
                myChart.resize()
            })
        ...
        getPieLine(seriesFn){
            ...
            // 基于准备好的dom，初始化echarts实例
            let myChart = this.$echarts.init(document.getElementById('indexPieChart'), 'dark')
            myChart.setOption(option);
            window.addEventListener("resize", function () {
                myChart.resize()
            })
...
.proIndex{
    ...
    .proBiao{
        ...
        .biaoOne{
            ...
            border-radius: 15px;
            box-shadow: 6px 3px 17px -14px black;
            background-image: url('../assets/windFramPicture/indexPage1x.png');
        }
        .biaoTwo{
            padding: 10px 0 0 10px;
            color: hsla(0,0%,100%,.75);
            ...
            border-radius: 15px;
            box-shadow: 6px 3px 17px -14px black;
            background-image: url('../assets/windFramPicture/indexPage2x.png');
        }
        .biaoThree{
            padding: 10px 0 0 10px;
            color: hsla(0,0%,100%,.75);
            ...
            border-radius: 15px;
            box-shadow: 6px 3px 17px -14px black;
            background-image: url('../assets/windFramPicture/indexPage3x.png');
        }
        .biaoFour{
            padding: 10px 0 0 10px;
            color: hsla(0,0%,100%,.75);
            ...
            border-radius: 15px;
            box-shadow: 6px 3px 17px -14px black;
            background-image: url('../assets/windFramPicture/indexPage4x.png');
        }
    }
    .proTable{
        margin-top:25px;
